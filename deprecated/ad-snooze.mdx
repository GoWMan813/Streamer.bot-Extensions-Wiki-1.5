...
# Tutorial
<YouTube videoId="ORb1EGwZRPA" opts={{width:830, height:467}} />
...
After each relogin on Twitch site you will have to get this data again.
</Callout>
...
This method uses undocumented API, so it can break at any moment.
</Callout>

# Contributors
- [TheShiningOne](https://www.twitch.tv/TheShiningOne)