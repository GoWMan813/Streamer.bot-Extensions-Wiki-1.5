...
Remember because you want it to read input you will need to have the 'Location' set to 'Start'
</Callout>
...
Remember Channel Points used in this way are non-refundable so take care in the amount you use.
</Callout>
