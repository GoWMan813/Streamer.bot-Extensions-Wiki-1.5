...
2. Copy `Import Code` and import into Streamer.bot using the `Import` button in top left of the bot
...
Codepen source: https://codepen.io/team/keyframers/pen/NWpGrWZ


# Contributors
- [Lyfesaver](https://www.twitch.tv/Lyfesaver74)

- [Keyframers on Codepen](https://codepen.io/team/keyframers)

- [Keyframers on Twitter](https://codepen.io/team/keyframers)

- [Shaw on Twitter](https://twitter.com/shshaw)