...
This will allow up to 10 answers so 0.1.9+ is needed.
</Callout>
## Import Code
```md copy
...
You may need to add `System.Core.dll` to get the codes to compile.
</Callout>
...
<Callout type="info" emoji="ℹ️">
For more info about codepens check out Lyfesavers Video on Codepens Here.
</Callout>
...
<Callout type="error" emoji="️🚫">
As we are going to need to add info its important that you DO NOT tick local file.
</Callout>
