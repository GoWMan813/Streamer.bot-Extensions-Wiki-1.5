...
# Tutorial
<YouTube videoId="wxCPOULpZv8" opts={{width:830, height:467}} />
...
It's Important to note if you use any but just `%user%` the sub-action **QueuePosition** and **LeaveQueue** Will _**NOT**_ work.
</Callout>
...
![logQueue](/assets/user-queue-system/images/logQueue.png)
