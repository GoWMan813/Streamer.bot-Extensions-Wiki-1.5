---
title: Stream Chat
description: Chat Overlay for OBS based on (https://streamer.bot/)'s websocket, using pronouns from (https://pronouns.alejo.io/).
---
...
### Contributors / Thanks
- [izzy](https://www.twitch.tv/itsizzy)
- [@andi242](https://github.com/andi242/twitch-chat)