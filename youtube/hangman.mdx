...
It's important you don't use `Local File` in OBS.
</Callout>
## Streamerbot Setup
...
<Callout type="warning" emoji="⚠️">
If using this from a text file place a new text file in a safe location and add each word to a new line.
</Callout>
...
Words range from 5 to 13 letters the last time I tested this.
</Callout>
